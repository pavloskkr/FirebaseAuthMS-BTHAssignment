package bth.assignment.FirebaseAuthMS.controllers;
...
public class AuthorizationController {
    ...
    @Value("AIzaSyCfDjL3fOOqOxD1doWa5Pxc6aDWTnyF-pA")
    ...
    public TokenResponse register(@RequestBody Credentials credentials) {
        String FIREBASE_SIGN_UP_URL = ":signUp";
    ...
    public TokenResponse fetchToken(@RequestBody Credentials credentials) {
        String FIREBASE_SIGN_IN_URL = ":signInWithPassword";
        return restTemplate.postForObject(
